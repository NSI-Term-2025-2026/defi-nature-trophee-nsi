...
- Mode jeu (Pygame) : python main.py play
- Mode stats (sans Pygame) : python main.py stats
"""
...
def main():
    ...
    print("Mode inconnu.")
    print("Utilisation :")
    print("  python main.py play   # jeu Pygame")
    print("  python main.py stats  # simulations sans Pygame")
